...
class ErrorException(Exception):
    ...
    def __init__(self, params=None, payload=None, error_code=None, message=None):
        ...
        if error_code is not None:
            ...
            self.detail = self.suberror_details.get(error_code, self.__class__.detail)
...
class InvalidParameter(BadRequest):
    ...
    suberror_details = {
        ...
        "4001002": "username or password is incorrect",
        "4001003": "{param} is invalid",
        "4001004": "password is not strong enough",
    }
